...
The exported TypeScript declarations document all configuration and collection APIs. A native-host Hybrid diagnostic sample covering automatic collection and Session Replay is available in the [`examples/`](examples/README.md) directory.
